...
open class MSGMessengerViewController: UIViewController {
    ...
    private(set) public lazy var chatProgressBar : ChatProgressBar = {
        return ChatProgressBar(frame: .zero)
    }()
    ...
    /// The delegate for the more items
    public weak var delegateMoreItems : MSGMessengerLoadMoreItems?
    ...
    private func loadFromDefaultNib() {
        ...
        /// add the progress in the view chain
        view?.add(chatProgressBar)
